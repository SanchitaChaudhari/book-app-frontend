                ...
                <div className="overflow-y-auto" style={{maxHeight: '24rem'}}>
                  <ul className="p-6 space-y-6">
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Priyanka Rathore</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Charlie D'souza</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Rajesh Yadav</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Ajay Deshmukh</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Arya Sharma</span>
                      <span className="ml-auto font-semibold">8.2</span>
                    </li>
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                      ...
                      <span className="text-gray-600">Mariya Mishra</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Punit Rajput</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Neeraj Chopra</span>
